                ...
                child: Center(
                  child: MaxWidthBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Text("Select Provider", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18)),
                        ...
                        const Text("Phone Number", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18)),
                        const SizedBox(height: 12),
                        
                        _buildTextField(
                          controller: _phoneController,
                          focusNode: _phoneFocus,
                          hint: "Enter number to charge",
                          icon: Icons.phone_android_rounded,
                          theme: theme,
                        ),

                        const SizedBox(height: 20),
                        const Text("Service PIN", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18)),
                        const SizedBox(height: 12),
