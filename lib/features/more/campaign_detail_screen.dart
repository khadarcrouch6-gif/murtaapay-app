    ...
    return Scaffold(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FadeInUp(
                      ...
                      child: Text(state.translate("About", "Ku saabsan", ar: "حول", de: "Über"), style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: theme.textTheme.titleMedium?.color)),
                    ),
                    const SizedBox(height: 16),
                    FadeInUp(
      ...
      bottomSheet: Container(
        ...
        child: ElevatedButton(
          ...
          child: Text(state.translate("Donate Now", "Hadda Deeq Bixi", ar: "تبرع الآن", de: "Jetzt spenden"), style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.white)),
        ),
      ),
    );
  }
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 24),
                Text(state.translate("Choose Donation Amount", "Dooro Cadadka Deeqda", ar: "اختر مبلغ التبرع", de: "Spendenbetrag wählen"), style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: theme.textTheme.titleLarge?.color)),
                const SizedBox(height: 24),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: state.translate("Custom Amount", "Cadad Kale", ar: "مبلغ مخصص", de: "Eigener Betrag"),
                ...
                ElevatedButton(
                  ...
                  child: Text(state.translate("Confirm Donation", "Xaqiiji Deeqda", ar: "تأكيد التبرع", de: "Spende bestätigen"), style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.white)),
                ),
