...
class _VouchersScreenState extends State<VouchersScreen> {
  ...
  void _redeemVoucher(String code, AppState state) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(state.translate("Voucher code copied! Ready to use.", "Koodhka waatsharka waa la koobiyeeyay!", ar: "تم نسخ رمز القسيمة! جاهز للاستخدام.", de: "Gutscheincode kopiert! Bereit zur Verwendung.")),
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildStep(context, state, theme, 2, state.translate("Start a new money transfer.", "Bilow xawaalad lacageed oo cusub.", ar: "ابدأ تحويلاً مالياً جديداً.", de: "Starten Sie eine neue Geldüberweisung."), 600),
                      _buildStep(context, state, theme, 3, state.translate("Paste code in the 'Promo Code' field.", "Dhig koodhka qaybta 'Promo Code'.", ar: "أالصق الرمز في حقل 'رمز الترويجي'.", de: "Fügen Sie den Code in das Feld „Promo-Code“ ein."), 700),
  ...
  List<Widget> _buildVoucherList(BuildContext context, AppState state, ThemeData theme, bool isDark) {
    return [
      _buildTicketVoucher(
        ...
        desc: state.translate("Get 5% cashback on your next transfer.", "Hel 5% lacag celin ah xawaaladdaada xigta.", ar: "احصل على استرداد نقدي بنسبة 5% على تحويلك التالي.", de: "Erhalten Sie 5 % Cashback auf Ihre nächste Überweisung."),
        code: "WELCOME5",
        color: const Color(0xFFF59E0B),
        expiry: state.translate("Expires: 30 Dec", "Dhacaya: 30 Dec", ar: "تنتهي في: 30 ديسمبر", de: "Läuft am 30. Dez. ab"),
      ...
      _buildTicketVoucher(
        ...
        expiry: state.translate("Expires: Tomorrow", "Dhacaya: Berri", ar: "تنتهي غداً", de: "Läuft morgen ab"),
      ...
      _buildTicketVoucher(
        ...
        desc: state.translate("\$10 bonus on transfers over \$100.", "\$10 oo gunno ah xawaaladaha ka badan \$100.", ar: "مكافأة 10 دولارات auf التحويلات التي تزيد عن 100 دولار.", de: "10 \$ Bonus auf Überweisungen über 100 \$."),
        code: "EID2024",
        color: const Color(0xFF8B5CF6),
        expiry: state.translate("Expires: in 5 days", "Dhacaya: 5 maalin", ar: "تنتهي خلال 5 أيام", de: "Läuft in 5 Tagen ab"),
