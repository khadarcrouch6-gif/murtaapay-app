        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                // Top Row: Eye/Copy Icons and Murtaax Pay Logo
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          FittedBox(fit: BoxFit.scaleDown, child: Text(state.translate("Card Holder", "Milkiilaha", ar: "صاحب البطاقة", de: "Karteninhaber").toUpperCase(), style: TextStyle(color: Colors.white.withValues(alpha: 0.5), fontSize: 9, letterSpacing: 1))),
                          const FittedBox(fit: BoxFit.scaleDown, child: Text("KHADAR RAYAALE", style: TextStyle(color: Colors.white, letterSpacing: 1.5, fontWeight: FontWeight.w600, fontSize: 13))),
                        ],
                      ),
                    ),
                    ...
                    Column(
                      ...
                      children: [
                        FittedBox(fit: BoxFit.scaleDown, child: Text(state.translate("Expires", "Dhicitaanka", ar: "تنتهي في", de: "Ablauf").toUpperCase(), style: TextStyle(color: Colors.white.withValues(alpha: 0.5), fontSize: 9, letterSpacing: 1))),
                        const FittedBox(fit: BoxFit.scaleDown, child: Text("12/26", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 13))),
                      ],
                    ),
                  ],
                ),
