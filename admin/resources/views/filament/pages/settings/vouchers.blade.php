...
<div class="sp-header">
    <div>
        <div class="sp-header-title">🎟️ Voucher Settings</div>
        <div class="sp-header-sub">Configure user-generated vouchers and creation fees.</div>
    </div>
</div>
...
<div class="sp-card">
    <div class="sp-card-header">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#db2777" style="width:18px;height:18px"><path d="M11.644 3.066a2.25 2.25 0 0 0-3.288 0l-4.72 4.72a.75.75 0 0 0 0 1.06l4.72 4.72a2.25 2.25 0 0 0 3.288 0l4.72-4.72a.75.75 0 0 0 0-1.06l-4.72-4.72Z" /><path d="M14.22 8.28a.75.75 0 1 1-1.06 1.06l-4.72-4.72a2.25 2.25 0 0 1 0-3.182l4.72 4.72.105-.105a2.25 2.25 0 0 1 3.182 0l-1.061 1.06-.106 1.06Z" /></svg>
        <div class="sp-card-title">Voucher Policy</div>
    </div>
    <div class="sp-card-body">
        <div class="sp-grid-2">
             <div class="sp-field">
                <label class="sp-label">Allow Users to Create Vouchers</label>
                <select class="sp-select" wire:model="settings.allow_user_create_voucher">
                    <option value="1">YES – Activated</option>
                    <option value="0">NO – Deactivated</option>
                </select>
            </div>
             <div class="sp-field">
                <label class="sp-label">Creation Fee (USD)</label>
                <input class="sp-input" wire:model="settings.voucher_create_fee" type="text" placeholder="0.50">
            </div>
            <div class="sp-field">
                <label class="sp-label">Minimum Amount (USD)</label>
                <input class="sp-input" wire:model="settings.min_voucher_amount" type="text" placeholder="1.00">
            </div>
             <div class="sp-field">
                <label class="sp-label">Maximum Amount (USD)</label>
                <input class="sp-input" wire:model="settings.max_voucher_amount" type="text" placeholder="1000.00">
            </div>
            <div class="sp-field">
                <label class="sp-label">Expiration Period (Days)</label>
                <input class="sp-input" wire:model="settings.voucher_expiration_days" type="number" placeholder="30">
            </div>
        </div>
    </div>
</div>
